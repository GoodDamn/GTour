...
public class Parks extends Fragment  implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view_Map = v.findViewById(R.id.Button_viewMap);
        return v;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        SupportMapFragment fragment = (SupportMapFragment)  getChildFragmentManager().findFragmentById(R.id.mapParks);
    ...
    public void onStart() {
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                ...
                {
                    if (snapshot.child("type").getValue().toString().equals("Park"))
                    {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            switch (which)
                            {
                                ...
                                case DialogInterface.BUTTON_NEGATIVE:
                                    Message("Application can't determine your geolocation. Turn on GPS.");
                                    break;
                            }
                        }
                    };
