...
public class ShowMapFragment extends Fragment implements OnMapReadyCallback{
    ...
    private void getLocationUser()
    {
        ...
        {
            Message("Application can't get data about your location. Please, turn on 'location'");
        }
    ...
    private void ReceivingDataFromFireBase()
    {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren())
                    {
                        gMap.addMarker(new MarkerOptions()
                                ...
                                .icon(BitmapDescriptorFactory.defaultMarker(CheckingType(snapshot.child("type").getValue().toString()))));
        ...
        {
            Message("Error, when data is receiving from database. Code error:" + ex.getMessage());
        }
    }
    ...
    private void getPermissionOnLocation()
    {
        try
        {
        ...
        {
            Message("Error, when application is receiving permission on using geolocation of user. Code error:" + ex.getMessage());
        }
    ...
    private void Message(String text) {Toast.makeText(getContext(), text, Toast.LENGTH_LONG).show();}
}
